...
window.I18N_DA = {
  ...
  "rsvp.m.bach": "Polterabend",
  "rsvp.m.bach.hint": "Vi inviterer jer ogs&aring; til at deltage i vores polterabend, som finder sted p&aring; Bornholm fredag eftermiddag den 3. september 2027. Hvis vejret tillader det, leder John en 10 km cykeltur til mikrobryggeriet Mikkeller i &Aring;rsdale, mens Christina er v&aelig;rt for en strandpicnic med kreative aktiviteter i Snogeb&aelig;k. Ledsagere er velkomne til at deltage i begge arrangementer.",
  "rsvp.bach.bike": "Cykeltur med John",
  "rsvp.bach.picnic": "Strandpicnic med Christina",
  "rsvp.bach.optout": "Deltager ikke",
  ...
  "rsvp.po.bach": "Ledsagerens polterabend-arrangement",
  "rsvp.po.bach.al": "Ledsagerens polterabend-arrangement",
  ...
  "rsvp.js.sum.bach": "Fredagsarrangement:",
...
window.I18N_EN = {
  ...
  "rsvp.js.sum.bach": "Friday event:",
  // Also live in rsvp.html as data-i18n labels, but the summary renders them
  // from JS via i18n.t(), which falls back to I18N_EN — without these the
  // English receipt would print the bare key.
  "rsvp.bach.bike": "Bike trip with John",
  "rsvp.bach.picnic": "Beach picnic with Christina",
